  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12 font-sans selection:bg-rose-200">
      ...
      <figure className="mb-10 rounded-2xl overflow-hidden shadow-xl border border-slate-100">
        <img 
          src="[https://images.unsplash.com/photo-1590123654443-41a45778844f?auto=format&fit=crop&q=80&w=1200](https://images.unsplash.com/photo-1590123654443-41a45778844f?auto=format&fit=crop&q=80&w=1200)" 
